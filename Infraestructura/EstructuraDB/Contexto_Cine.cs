...
namespace Infraestructura.EstructuraDB
{
    public class Contexto_Cine : DbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer(@"Server=.\SQLEXPRESS;Database=Cine/FrancoPaiz;Trusted_Connection=True;TrustServerCertificate =true");
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Peliculas>(Entity =>
            {
                ...
                Entity.HasKey(pk => pk.Peliculaid);
                Entity.Property(pk => pk.Peliculaid).ValueGeneratedOnAdd().IsRequired();
            ...
            modelBuilder.Entity<Generos>(Entity =>
            {
                ...
                Entity.HasKey(pk => pk.GeneroId);
                Entity.Property(pk => pk.GeneroId).ValueGeneratedOnAdd().IsRequired();
                Entity.Property(a => a.Nombre).HasMaxLength(50).IsRequired();
            });
